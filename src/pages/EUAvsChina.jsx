        ...
        >
            <Box sx={{ mb: 4 }}>
                ...
                <Typography component="p" sx={{ lineHeight: 1.8, mb: 2 }}>
                    A rivalidade EUA-China deixou de ser uma competição dentro do mesmo sistema global. Washington busca agora o <strong>desengajamento</strong> (<em>decoupling</em>) em setores críticos, enquanto a União Europeia adota o termo mais suave, <em>de-risking</em> (redução de risco). O objetivo é isolar a China do acesso a tecnologias militares e de dupla utilização, protegendo as cadeias de suprimentos estratégicas ocidentais.
                </Typography>
