...
import PublicIcon from "@mui/icons-material/Public"; // Ícone da Terra para o título da Hero
import theme from "../theme"; 

// -------------------------------------------------------------------
// Dados dos Tópicos (EXPORTADO para ser usado no Layout.jsx)
// -------------------------------------------------------------------
...
// -------------------------------------------------------------------
// Componente Home Content (Página Principal)
// -------------------------------------------------------------------
export default function Home() {
  ...
  return (
    <>
      {/* 1. Hero Section (Melhorada para se parecer com a imagem) */}
      <Box
        sx={{
      ...
      {/* 2. Conteúdo Principal (Lista de Tópicos) - Mantido */}
