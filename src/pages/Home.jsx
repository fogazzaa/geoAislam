...
const topicosData = [
  {
    ...
    path: "/guerra-ucrania",
    icon: <LandscapeIcon sx={{ fontSize: 40, color: "#d32f2f" }} />,
  },
  {
    ...
    icon: <BusinessIcon sx={{ fontSize: 40, color: "#2ECC71" }} />,
  },
  {
    key: "eua_vs_china",
...
export default function Home() {
  ...
  return (
    <>
      ...
      >
        <Container maxWidth="lg" sx={{ textAlign: "center" }}>
          <Box sx={{ maxWidth: 800, mx: "auto" }}>
            <PublicIcon
              sx={{ color: theme.palette.primary.light, fontSize: 48, mb: 1 }}
            />
            <Typography
              variant="h3"
              component="h1"
            ...
            >
              Análise dos <strong>conflitos</strong> e{" "}
              <strong>tendências globais</strong> que definem a nova ordem
              mundial.
            </Typography>
      ...
      >
        <ModalUltimasNoticias news={selectedNews} onClose={handleCloseModal} />
      </Modal>
    </>
  );
}
